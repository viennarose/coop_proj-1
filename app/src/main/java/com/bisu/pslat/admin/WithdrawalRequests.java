...
public class WithdrawalRequests extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_withdrawal_requests);
        simpleList = (ListView)findViewById(R.id.paymentListView);
        Button back = (Button) findViewById(R.id.backButton);

        mDatabase = FirebaseDatabase.getInstance().getReference();
        mDatabase.child("withdrawal_requests").orderByChild("status").equalTo("pending")
                        ...
                        if (task.exists()){
                                ...
                                mDatabase.child("users").child(user_id).get()
                                        .addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
                                            ...
                                            public void onComplete(@NonNull Task<DataSnapshot> task2) {
                                                ...
                                                ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(WithdrawalRequests.this, R.layout.activity_listview, R.id.textView, userList);
                            ...
                            simpleList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                    ...
                                    Intent go = new Intent(WithdrawalRequests.this,WithdrawalRequestInformation.class);
                            ...
                            Toast.makeText(WithdrawalRequests.this, "No payment requests", Toast.LENGTH_SHORT).show();
                        }
                    }
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(WithdrawalRequests.this, AdminMainActivity.class);
