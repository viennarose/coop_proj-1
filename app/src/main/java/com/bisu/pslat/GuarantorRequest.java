...
public class GuarantorRequest extends AppCompatActivity {
    ListView simpleList;
    private DatabaseReference mDatabase;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_guarantor_request);
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            ...
                            for (DataSnapshot child : snapshot.getChildren()) {
                                ...
                                if (user != null) {
                                if(user_id.matches(user.getUid())){
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
                                                ...
                                                public void onComplete(@NonNull Task<DataSnapshot> task2) {
                                                    if (!task2.isSuccessful()) {
                                                        ...
                                                        Log.d("HHHH",child.child("date_created").getValue().toString());
                                                        ...
                                                        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(GuarantorRequest.this, R.layout.activity_listview, R.id.textView, userList);
                            ...
                            simpleList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                ...
                                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                    ...
                                    Intent go = new Intent(GuarantorRequest.this, GuarantorRequestInformation.class);
                            ...
                            Toast.makeText(GuarantorRequest.this, "No pending requests", Toast.LENGTH_SHORT).show();
                        }
                    }
